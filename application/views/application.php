      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            ...
            <p class="intro-txt"></p>
            <div class="home-btn">
              <p><a href="#works" class="portfolio-btn scrolltoanchor"><img src="webroot/images/portfolio_icon.png" alt=""/> <span>View <br>Portfolio</span></a></p>
              <p><a href="#contact" class="contact-btn scrolltoanchor"><img src="webroot/images/contact_icon.png" alt=""/> <span>View <br>Contact</span></a></p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="page-space">
                ...
                <div class="team-img">
                  ...
                  <div class="social-icons">
                    <ul>
                      ...
                      <li><a href="https://www.facebook.com/muhamadakbarbw" target="_blank" class="facebook tipsy" title="Facebook">Facebook</a></li>
                      <li><a href="https://plus.google.com/106264353458949960079" target="_blank" class="gplus tipsy" title="Google plus">Google plus</a></li>
                    </ul>
                  </div>
                </div>
                <div class="team-txt">
                  ...
                  The principle of me are discipline, excellence, and powerful. Please going with 
            ...
            <div class="span4">
              ...
              <ul id="services-graph">		
                <li><span title="90"></span><p>Ruby on Rails <strong>90%</strong></p></li>
                <li><span title="60"></span><p>Jquery <strong>80%</strong></p></li>
                <li><span title="90"></span><p>Ubuntu <strong>80%</strong></p></li>
                <li><span title="95"></span><p>HTML5/CSS <strong>80%</strong></p></li>
                <li><span title="85"></span><p>Photoshop <strong>65%</strong></p></li>
              </ul>
            </div>
            <div class="clearfix"></div>
            <div class="span12">
