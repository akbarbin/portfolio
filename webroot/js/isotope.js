...
(function(a,b,c){
  ...
  var e="Moz Webkit Khtml O Ms".split(" "),g=f("transform"),h={
  ...
  if(a.Modernizr)for(var i in h)Modernizr.hasOwnProperty(i)||Modernizr.addTest(i,h[i]);else a.Modernizr=function(){
    ...
    for(e in h)d=h[e](),a[e]=d,c+=" "+(d?"":"no-")+e;b("html").addClass(c);
    return a
  }();
  if(Modernizr.csstransforms){
    var j=Modernizr.csstransforms3d?{
      ...
      f[c]=d,b.extend(e,f);
      for(h in e)k=e[h],i[h]=j[h](k);var l=i.translate||"",m=i.scale||"",n=l+m;
  ...
  b.Isotope.settings={
    ...
    updateSortData:function(a,c){
      ...
      a.each(function(){
        ...
        for(var a in e)g[a]=e[a](f,d);b.data(this,"isotope-sort-data",g),c&&d.elemCount++
      })
    },
    _sort:function(){
    ...
    var b=this.find("img"),c=[],d=this,e=b.length;
    if(!b.length){
      a.call(this);
      return this
    }
